...
const CURRENT_APP_PERMISSION_GRANTS = new Set([
  ...
  "tool.desktop.listWindows",
  "tool.desktop.focusWindow",
  ...
  "tool.desktop.setControlText",
  "tool.desktop.invokeControl",
  "tool.web.search",
  "tool.web.fetch",
