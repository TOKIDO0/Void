...
const CAPABILITY_GROUPS: CapabilityGroupDefinition[] = [
  ...
  },
  {
    ...
    requiresBridge: true,
    toolNames: ["desktop.openKnownLocation", "desktop.listInstalledApplications", "desktop.launchApplication", "desktop.listWindows", "desktop.focusWindow", "desktop.closeWindow", "desktop.getSystemInfo", "desktop.screenshot", "desktop.setWindowBounds", "desktop.openFile", "desktop.inspectWindowControls", "desktop.revealPath"]
  },
  {
    id: "security",
    label: "本地安全自检",
