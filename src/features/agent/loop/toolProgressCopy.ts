...
const TOOL_PROGRESS_LABELS: Record<string, string> = {
  ...
  "agent.todo": "正在更新任务清单…",
  "agent.goal": "正在管理本轮目标…",
  "agent.askUser": "正在整理要确认的问题…",
  "agent.spawnTask": "正在派生子任务…",
...
const TOOL_CONFIRM_LABELS: Record<string, string> = {
  ...
  "desktop.closeWindow": "请确认是否关闭该窗口",
  "desktop.openFile": "请确认是否打开该文件",
  "file.createDirectory": "请确认是否创建目录",
  "file.move": "请确认是否移动或重命名",
  "file.writeText": "请确认是否写入文本文件",
  "file.editText": "请确认是否编辑该文件内容",
